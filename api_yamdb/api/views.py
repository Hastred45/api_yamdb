...
from .serializers import (CategoriesSerializer, ReviewSerializer, CommentsSerializer,
...
class ReviewViewSet(viewsets.ModelViewSet):
    ...
    2. Добавить новый отзыв. Пользователь может оставить только один отзыв на произведение.
    ...
    5. Удалить отзыв по id. Доступно только авторам отзыва, модераторам или администраторам.
    '''
...
class CommentsViewSet(viewsets.ModelViewSet):
    ...
    5. Удалить комментарий к отзыву по id. Доступно только авторам комментария, модераторам или администраторам.
    '''
